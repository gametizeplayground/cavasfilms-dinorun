class DinoGame {
    constructor() {
        ...
        this.quizQuestions = [
            {
                question: "Which habit best supports your well-being and long-term growth?",
                options: ["A) Taking time to recharge", "B) Using stress as your main motivator", "C) Skipping breaks to stay productive", "D) Handling every task alone"],
                answer: 0
            },
            {
                question: "Which mindset best helps unlock potential during uncertain times?",
                options: ["A) Waiting for certainty before acting", "B) Focusing only on worst-case outcomes", "C) Taking small steps and staying adaptable", "D) Avoiding change until it passes"],
                answer: 2
            },
            {
                question: "Which approach makes storytelling more powerful and persuasive?",
                options: ["A) More facts", "B) Emotion", "C) Longer explanations", "D) Generic details"],
                answer: 1
            },
            {
                question: "Why are stories often more persuasive than facts alone?",
                options: ["A) Efficiency", "B) Memorability", "C) Structure", "D) Precision"],
                answer: 1
            },
            {
                question: "Where can storytelling be useful at work?",
                options: ["A) Presentations", "B) Leadership meetings", "C) Everyday interactions", "D) All of the above"],
                answer: 3
            },
            {
                question: "When you feel at a loss, what can help you move forward?",
                options: ["A) Evolve", "B) Retreat", "C) Overthink", "D) Wait"],
                answer: 0
            },
        ];
    ...
    setupEventListeners() {
        ...
        // Touch + mouse controls (pointer events) for consistent jump behavior
        document.addEventListener('pointerdown', (e) => {
            // Only react to primary/left button for mouse pointers
    ...
    getNextEggTime() {
        // Random interval: every 4.5-13 seconds (slightly more frequent)
        return performance.now() + 4000 + Math.random() * 8000;
    }
